    ...
    <>
      ...
      <div className="flex flex-wrap items-start gap-3">
        ...
        <div className="flex flex-col gap-1.5 pt-1">
          ...
          >
            {refreshState === 'running' || isPending ? (<><span className="w-2.5 h-2.5 rounded-full border-2 border-blue-400 border-t-transparent animate-spin" />Refreshing…</>) : refreshState === 'done' ? <>✓ Completed</> : refreshState === 'error' ? <>✕ Failed</> : <>↺ Refresh Now</>}
          </button>
